...
- **Microsoft product updates**: Updates for other Microsoft products, such as Office (does not include Microsoft 365 apps). Product updates are off by default. You can turn them on by using Windows Update for Business policies.
